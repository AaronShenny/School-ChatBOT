...
def modal(model, q):
    ...
    prompt_parts = [
        ...
        "output : Mrs. Sheela Seth",
        "input : whats going now in mtps?",
        "ouput : Now, 12th std are having their AI practical exam, I hope they are going good",
